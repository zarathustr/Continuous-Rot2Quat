...
quaternion_proposed = zeros(len, 4);
gains = zeros(len, 1);
eigen = zeros(len, 1);
...
for i = 1 : len
    ...
    qq = Rot2QuatCont(C_true, qq);
    [V, D] = eig(K);
    eigen(i) = D(4, 4);
    quaternion_proposed(i, :) = qq';
    
end
if(norm(quaternion_true - quaternion_proposed) / len > 1e-3)
    quaternion_proposed = - quaternion_proposed;
end
...
figure(4);
subplot(2, 2, 1);
plot(time, quaternion_proposed(:, 1), 'LineWidth', 2); hold on
plot(time, quaternion_true(:, 1), '--', 'LineWidth', 1); hold off
...
subplot(2, 2, 2);
plot(time, quaternion_proposed(:, 2), 'LineWidth', 2); hold on
plot(time, quaternion_true(:, 2), '--', 'LineWidth', 1); hold off
legend('Proposed', 'Reference');
xlim([0 max(time)]);
xlabel('Time (s)');
...
subplot(2, 2, 3);
plot(time, quaternion_proposed(:, 3), 'LineWidth', 2); hold on
plot(time, quaternion_true(:, 3), '--', 'LineWidth', 1); hold off
legend('Proposed', 'Reference');
xlim([0 max(time)]);
xlabel('Time (s)');
...
subplot(2, 2, 4);
plot(time, quaternion_proposed(:, 4), 'LineWidth', 2); hold on
plot(time, quaternion_true(:, 4), '--', 'LineWidth', 1); hold off
legend('Proposed', 'Reference');
xlim([0 max(time)]);
xlabel('Time (s)');
...
figure(7);
subplot(2, 2, 1);
plot(time, quaternion_proposed(:, 1) - quaternion_true(:, 1), 'LineWidth', 1);
xlim([0 max(time)]);
xlabel('Time (s)');
ylabel('Error q_0');
...
subplot(2, 2, 2);
plot(time, quaternion_proposed(:, 2) - quaternion_true(:, 2), 'LineWidth', 1);
xlim([0 max(time)]);
xlabel('Time (s)');
ylabel('Error q_1');
...
subplot(2, 2, 3);
plot(time, quaternion_proposed(:, 3) - quaternion_true(:, 3), 'LineWidth', 1);
xlim([0 max(time)]);
xlabel('Time (s)');
ylabel('Error q_2');
...
subplot(2, 2, 4);
plot(time, quaternion_proposed(:, 4) - quaternion_true(:, 4), 'LineWidth', 1);
xlim([0 max(time)]);
xlabel('Time (s)');
ylabel('Error q_3');
